...
Create the following files from the templates. For this step you'll need ot create an oauth 2.0 web client ID from the GCP console, as per the instructions in `secrets_template.py`.
